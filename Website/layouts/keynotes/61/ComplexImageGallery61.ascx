<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ComplexImageGallery61.ascx.cs"
...
<div class="wrapper clearfix">
    <sc:EditFrame ID="GalleryFrame" runat="server" Buttons="/sitecore/content/Applications/WebEdit/Edit Frame Buttons/Keynote" HintOffset="3">
