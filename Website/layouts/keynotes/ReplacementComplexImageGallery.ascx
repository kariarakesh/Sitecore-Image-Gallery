<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReplacementComplexImageGallery.ascx.cs"
    Inherits="Keynotes.layouts.keynotes.ReplacementComplexImageGallery" EnableViewState="false" %>
                ...
                <asp:ListView ID="VideoItems" runat="server">
                    <ItemTemplate>
                        <div class="item item_1">
                            <object type="application/x-shockwave-flash" width="604" height="340" data="<%# ((Item)Container.DataItem).Fields["Url"].Value %>">
...
<div class="contentarea">
    <cc2:FileDropAreaGridView ID="FileDrop" runat="server" FieldName="File" AutoGenerateColumns="false"
        ...
        OnRowCreated="FileDrop_RowCreated">
        <Columns>
